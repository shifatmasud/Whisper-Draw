...
-   **[2024-05-21 17:00]**: Refactored `Stage.tsx` into a modular `Stage/` folder. Extracted `CanvasEngine` and `PathUtils`. Fixed `importSVG` normalization. Fixed vector path editability bug for nested paths.
