...
-   `components/Package/Toolbar.tsx`
-   `components/Page/TextureEditor.tsx`
-   `components/Section/Dock.tsx`
-   `components/Section/Stage/index.tsx`
-   `components/Section/Stage/Engine.ts`
-   `components/Section/Stage/PathUtils.ts`
-   `components/Section/Stage/modules/BuildModeManager.ts`
-   `components/Section/Stage/modules/Conversions.ts`
-   `components/Section/Stage/modules/IOManager.ts`
-   `components/Section/Stage/modules/InteractionManager.ts`
-   `components/Section/Stage/modules/PenToolManager.ts`
-   `components/Section/Stage/modules/SelectToolManager.ts`
-   `components/Section/Stage/modules/ShapeToolManager.ts`
-   `components/Section/Stage/modules/Util.ts`
-   `components/Section/Stage/modules/VectorManager.ts`
-   `README.md`
-   `LLM.md`
-   `noteBook.md`
-   `bugReport.md`
